...
/// The source of an explanation — either AI-generated or from a YAML rule definition.
public enum ExplanationSource: Sendable, Equatable {
    /// Generated by the local AI model.
    case ai
    /// Taken directly from the YAML rule's `explanation` field.
    case rule
}
